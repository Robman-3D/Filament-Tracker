...
function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#000597] text-white flex flex-col items-center p-4 overflow-hidden">
      ...
      <main className="relative z-10 w-full max-w-4xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Inventory List */}
          <section className="bg-white/90 backdrop-blur-md rounded-xl p-6 shadow-xl border border-white/20">
            <h2 className="text-xl font-semibold mb-4 text-slate-800">Your Filaments</h2>
            <InventoryList items={items} onDelete={handleDelete} />
            {loading && <p className="text-center text-blue-600 mt-2">Syncing...</p>}
          </section>

          {/* Add Item Form */}
          <section className="bg-white/90 backdrop-blur-md rounded-xl p-6 shadow-xl border border-white/20 h-fit">
            <h2 className="text-xl font-semibold mb-4 text-slate-800">Add New Spool</h2>
